...
$(MAIN_EXEC): catan.o Board.o Place.o Corner.o Player.o Game.o DevelopmentCard.o
	$(CXX) $(CXXFLAGS) -o $(MAIN_EXEC) catan.o Board.o Place.o Corner.o Player.o Game.o DevelopmentCard.o
...
main.o: catan.cpp Board.hpp Game.hpp Player.hpp
